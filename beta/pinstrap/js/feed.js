...
function makeFeedRequest() {
    if (page != -1) {
        var url="./bl/manage-feed.php?f=gf&p=" + page;
...
function appendFeed(feed) {
    var itemDiv = "<li><div style=\"border-radius:10px;margin-bottom: 5px;border:none\"><a class=\"showDialog link\" data-toggle=\"modal\" data-target=\".bs-example-modal-lg\" onclick=\"renderData(%DATA_ID%);\"><img class=\"img-responsive\" src=\"%IMAGE_URL%\" style=\"border-top-left-radius:10px;border-top-right-radius:10px;\" /></a><div class=\"descr\"><div class=\"row\"><div class=\"col-lg-12 col-xs-12\"><p class=\"truncable-txt\">%DESCRIPTION%</p></div></div><div class=\"row social-icons\"><div class=\"col-lg-6 col-xs-6\"><em class=\"glyphicon glyphicon-eye-open\" style=\"color: #a7a7a7;font-size:13px;\"></em><em style=\"color: #999;font-size: 13px;font-weight: normal;\"> %VIEWS%</em></div><div class=\"col-lg-6 col-xs-6\" style=\"text-align:right;\"><span><a href=\"#\" style=\"font-size:13px;\"\"></a></span></div></div></div><div class=\"row\"><div class=\"col-lg-12 col-xs-12\" class=\"text-align:center\"><a class=\"item-link\" target=\"_blank\" href=\"%LANDING_URL%\"><div class=\"checkout-item\">Check this Item!</div></a></div></div></div></div></li>";
